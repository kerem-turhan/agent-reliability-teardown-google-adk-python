...
|---|---|---|
| The target commit, tree, license and evaluated slice were fixed before any result was produced, at `20842eb8…`, Apache-2.0. | `research/target-freeze.json`, which records `resultsRunBeforeFreeze` | `npm run evidence:check` |
...
verifiable against upstream at any time; the ordering is not.
